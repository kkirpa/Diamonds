...
### Model Comparison
```{r}
model_names <- c("Linear regression", "RandomForest", "Decison Tree", "XGBoost", "Bestsubset(BIC)", "Bestsubset(AIC)")
rmse_values <- c(rmse, rmse_rf, rmse_tree, rmse_xgb, rmse_bic, rmse_aic)
